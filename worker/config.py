...
MIN_RALLY_SEC  = float(os.environ.get("MIN_RALLY_SEC", "5.0"))
PADDING_SEC    = float(os.environ.get("PADDING_SEC", "2.0"))
SAMPLE_FPS     = float(os.environ.get("SAMPLE_FPS", "3.0"))
# MOTION_THRESH giữ lại để không breaking change, không còn dùng trong MOG2
